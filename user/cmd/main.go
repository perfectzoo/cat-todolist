...
import (
	...
	"github.com/perfectzoo/cat-todolist/user/config"
	"github.com/perfectzoo/cat-todolist/user/discovery"
	"github.com/perfectzoo/cat-todolist/user/internal/handler"
